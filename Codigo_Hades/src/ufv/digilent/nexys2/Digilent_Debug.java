...
public class Digilent_Debug 
  ...
  public void evaluate( Object arg ) {
    ...
    if (signal_KEY0 == null) return;
    if (signal_KEY1 == null) return;
    if (signal_KEY2 == null) return;
    if (signal_KEY3 == null) return;
    if (signal_VIN == null) return;
    if (signal_RD == null) return;
    if (signal_MD == null) return;
    ...
    signal_temp = (SignalStdLogic1164) port_KEY0.getSignal(); 
